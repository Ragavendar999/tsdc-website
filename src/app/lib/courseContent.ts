...
export const defaultCourseContent: AllCourseContent = {
  'graphic-design': {
    ...
    faqs: [
      ...
      { question: 'What is the graphic design course fee?', answer: 'The TSDC Graphic Design Mastery Program is Rs 25,000 with a 3-month EMI option at Rs 8,334 per month, so you can start without paying the full amount upfront. The fee covers all course materials, software guidance, project reviews, and certification.' },
      { question: 'How long is the graphic design course?', answer: 'The TSDC AI-Powered Graphic Design Program runs for 3 months (12 weeks). This covers design fundamentals, Adobe tools, an AI-powered design workflow, branding, packaging, social creatives, and a complete portfolio review â€” structured so students are job-ready by the end.' },
      { question: 'Can I learn graphic design online?', answer: 'Yes. The TSDC AI-Powered Graphic Design Program is delivered fully online through live, instructor-led classes, so you can follow the full curriculum, get project feedback, and build your portfolio from anywhere.' },
      ...
      { question: 'Where can I do a graphic design course in Chennai?', answer: 'TSDC is a creative education institute based near OMR, Perumbakkam in Chennai. The AI-Powered Graphic Design Program is delivered fully online through live instructor-led classes, so students in Chennai and anywhere else can join with limited batch sizes for focused learning.' },
      ...
      { question: 'Can I pay in installments?', answer: 'Yes. The fee can be split into a 3-month EMI plan of Rs 8,334 per month so you can start without paying the full amount upfront.' },
      ...
      { question: 'What do I need to join the AI-Powered Graphic Design Program?', answer: 'You need a laptop or desktop capable of running Adobe Creative Cloud apps, a stable internet connection for live online classes, and access to ChatGPT, Gemini and Claude (free tiers are enough to start). No prior design or software experience is required.' },
      { question: 'Which AI tools are used in this course, and how?', answer: 'The program uses ChatGPT, Gemini and Claude as design assistants for research, ideation, content and brand strategy support â€” not as a replacement for design skills. Students learn prompt engineering and how to verify AI output rather than treating it as fact.' },
    ],
