...
export const defaultSiteContent: SiteContent = {
  ...
  coursesSection: {
    ...
    description:
      'Five in-demand creative skills with real projects, portfolio building, and mentor guidance for students in Chennai ready to make their move.',
    courses: [
      {
      ...
      },
      {
        ...
        role: 'Animation and ad motion path',
        tagline: 'Build animated titles, explainers, and brand motion with After Effects.',
        duration: '10 Weeks',
        skills: ['After Effects', 'Typography', 'Explainers'],
        careerPath: 'Motion Designer | Animator | Ad Creative',
        bonus: 'Motion portfolio + social ad animation',
        accent: '#db4b87',
